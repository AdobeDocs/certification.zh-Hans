...
[!DNL Adobe Commerce] 商业从业者专业人员
[!DNL Adobe Commerce] 开发人员专业版
[!DNL Adobe Commerce] 前端开发人员专业版
...
首先，选择 **两门课程** 完成并通过每个课程评估，其分数为80%或更高。 课程评估是免费、按需、非委托和公开的。 您可以重复这些课程，直到成功通过80%的评估为止。
  ...
  [客户参考表 [!DNL Adobe Commerce]](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA711){target="_blank"}
...
| [[!DNL Commerce]：与Experience Platform及外部的数据集成](https://video.tv.adobe.com/v/3413334/){target="_blank"} | [ADR-EA720](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA720){target="_blank"} |
...
## 免费的按需考试续签可供Adobe使用 [!DNL Commerce] 商业从业者专业人员

+++查看考试详细信息

### 您必须具备以下条件 **活动** 要使用此方法续订的认证：

Adobe Commerce商业从业者专业版
...
**第1部分：Magento Open Source核心功能(54%)**

识别Magento Open Source的功能区分正确的范围和何时使用每种功能演示目录管理的知识使用Magento Open Source功能操纵定价描述标准客户历程描述标准订单生命周期描述商店维护中涉及的日常任务说明不同类型的内容元素以及何时使用

**第2部分：Adobe Commerce基础知识(14%)**

识别Adobe Commerce中可用的主要功能识别Adobe Commerce中的服务插件识别Adobe Commerce的托管选项

**第3部分：数字营销和电子商务基础知识(22%)**

识别Adobe Commerce中可用的主要功能识别Adobe Commerce中的服务插件识别Adobe Commerce的托管选项识别电子商务网站的主要功能识别基本电子商务概念

**第4部分：合规/安全基本知识(10%)**

了解隐私法律和支付安全合规性的基础知识识别Adobe Commerce项目的常见安全方面识别辅助功能合规性的最佳实践和法律要求
...
* [Adobe Commerce 内容和设计指南](https://experienceleague.adobe.com/docs/commerce-admin/content-design/guide-overview.html){target="_blank"}
* [小组件](https://experienceleague.adobe.com/docs/commerce-admin/content-design/elements/widgets/widgets.html){target="_blank"}
* [Adobe Commerce 目录管理指南](https://experienceleague.adobe.com/docs/commerce-admin/catalog/guide-overview.html){target="_blank"}
* [Adobe Commerce商店和购买体验指南](https://experienceleague.adobe.com/docs/commerce-admin/stores-sales/guide-overview.html){target="_blank"}
...
* [增强的店面体验](https://experienceleague.adobe.com/docs/commerce-admin/start/storefront/enhanced-experiences.html){target="_blank"}
...
* [Adobe Commerce安全最佳实践](https://www.adobe.com/content/dam/cc/en/trust-center/ungated/whitepapers/experience-cloud/adobe-commerce-best-practices-guide.pdf){target="_blank"}
* [如何使您的电子商务网站符合ADA标准](https://business.adobe.com/blog/perspectives/understanding-ada-compliance-and-how-it-relates-ecommerce-websites){target="_blank"}
...
## 免费的按需考试续签可供Adobe使用 [!DNL Commerce] 开发人员专业版
...
描述ACL如何与角色和资源配合使用标识创建或修改管理网格/表单时要使用的组件标识创建存储/管理配置和菜单项时要使用的文件

**第2款：建筑(36%)**

描述Magento文件结构描述MagentoCLI命令描述cron功能给定场景，描述di.xml的使用给定场景，创建控制器描述模块结构描述索引功能描述本地化描述插件、首选项、事件观察器和拦截器描述自定义模块路由描述URL重写描述Magento缓存系统描述商店、网站和商店视图（基本理解）

**第3款：EAV/数据库(17%)**

给定一个方案，更改/添加/删除属性集和/或属性描述不同类型的属性给定一个方案，使用数据库模式更改数据库表描述模型、资源模型和集合描述实体属性值(EAV)的基础知识

**第4部分：布局/UI (18%)**

描述CMS页面和块的使用给定场景，修改布局给定场景，修改页面样式描述主题结构给定场景，使用JavaScript文件（基本）描述客户数据的前端使用

**第五节　：结账和销售(12%)**

描述购物车组件描述购物车促销规则给定场景，描述基本的结账修改给定场景，描述报价数据的基本使用给定场景，配置付款和送货方法给定场景，配置税则、货币、购物车和/或结账

**第六节　：目录(10%)**

确定类别管理和产品管理的基础知识描述产品类型描述价格规则描述价格类型
