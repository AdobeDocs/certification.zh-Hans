...
>现在提供免费的按需资源，帮助您准备考试：
>
>**课程**：如果您刚刚开始，则 [Adobe Commerce基础课程](https://app.rockinfo.com/courses/148) 提供了知识基础，您可以在认证历程中在此基础上进行构建。
>
>**考试准备指南：** 此 [考试准备指南](https://app.rockinfo.com/courses/playScorm/383) 提供量身定制的认证考试准备流程，包括成功获得此认证所需的深入学习材料。
>
