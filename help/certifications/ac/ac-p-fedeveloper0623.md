...
>[!NOTE]
>
>这是最新的Adobe Commerce前端开发人员专业知识考试。 如果您已经开始学习或计划了 [旧版本](ac-p-fedeveloper.md) 您必须在2023年8月18日之前完成此操作。

## 最低体验

您应该拥有0至12个月的Adobe Commerce前端开发实践经验，并能够使用技术解决方案交付各个组件。

此外，您还应展示以下技术的知识：

* 对Adobe Commerce版本2.4.6的深入了解
* 对前端结构和布局的基本了解
...
* [可观察项(DockOutJS)](https://knockoutjs.com/documentation/observables.html){target="_blank"}
...
[!BADGE 考试]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E721 newtab=true"}
