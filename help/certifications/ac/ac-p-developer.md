...
>现在提供免费的按需资源，帮助您准备考试：
>
>* **课程：**&#x200B;参加[Adobe Commerce Developer Professional课程](https://app.rockinfo.com/courses/92)，该课程包括对关键概念的解释、实践演示和知识检查。 如果您刚刚开始，[Adobe Commerce基础课程](https://app.rockinfo.com/courses/148)将为您提供基础知识，帮助您在认证历程中不断积累知识。
>
>* **考试准备指南：** [考试准备指南](https://app.rockinfo.com/courses/136)提供了通过考试准备过程量身定制的途径，包括考试成功所需的材料。
>
...
您应该能够熟练使用Adobe[!DNL Commerce]，并且对Adobe[!DNL Commerce]的管理员开发、体系结构、EAV/数据库、布局/UI、结帐和销售以及目录有基本的了解。
...
**第7部分：Adobe[!DNL Commerce]云架构(12%)**

* 定义Adobe[!DNL Commerce]架构/环境工作流
* 描述云项目文件、权限和结构
* 列出云中Adobe[!DNL Commerce]上可用的服务
* 描述如何访问不同类型的日志
...
* 描述Adobe[!DNL Commerce]云CLI工具的独占功能（CLI独占功能：激活电子邮件、重新构建环境、快照、数据库转储、本地环境设置）
* 描述使用Adobe[!DNL Commerce] Cloud CLI工具进行分支
...
[参加在线准备问卷](https://scorpion.caveon.com/launchpad/ad-q-e717-readiness-questionnaire-for-adobe-commerce-developer-professional/ad-q-e717-readiness-questionnaire-for-adobe-commerce-developer-professional){target="_blank"}
...
[查看考试准备指南](https://app.rockinfo.com/courses/136)
