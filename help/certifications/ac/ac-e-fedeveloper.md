...
solution: Commerce
role: Developer
badge: label="Exam AD0-E710" type="besitive"
mini-toc-levels: 1
...
# 认证历程Adobe [!DNL Commerce] 前端开发人员专家

了解如何成为经认证的Adobe Developer专家。

## 最低体验

您至少应具有1-3年的实践Adobe经验 [!DNL Commerce] 前端开发，并能够将任务需求所表达的需求转换为技术解决方案。
...
完成 [在线准备调查表](https://scorpion.caveon.com/launchpad/ad0-e710-adobe-commerce-front-end-developer-expert-copy-jtnjz6){target="_blank"} 以查看您当前的体验是否与建议的最低候选资格匹配。
...
* 演示创建新主题的功能（继承/回传、设计例外、主题属性）
* 演示扩展现有主题的功能
* 演示自定义事务电子邮件的功能
* 演示应用翻译的功能
* 给定一组用例，确定何时将文件放入应用程序/代码或应用程序/设计中

第二节：布局XML和模板（模板模板）(24%)
...
* 识别styles-m.less、styles-l.less、print.less的用途
* 描述特定局部文件(_extends.less、_extend.less、_theme.less、_widgets.less、_module.less、)之间的差异
* 演示覆盖或扩展MagentoLESS的功能
* 解释LESS的核心概念
* 演示设置电子邮件样式的功能
* 说明样式的层次结构（库、模块、主题）
* 演示实施和自定义LESS库组件的功能
* 识别客户端与服务器端编译之间的差异及其工作方式

第四节：JavaScript（图像小组件、图像库、客户数据模块、挖空模板）(22%)
...
第五节：管理员配置和PageBuilder(12%)

* 演示内容管理的用法
* 将主题应用/计划到特定范围（网站、商店、商店视图）
* 使用管理员配置将设计更改应用到类别、产品和CMS页面
* 描述前端优化
* 自定义事务型电子邮件
* 演示管理开发工具的使用情况
...
* [CSS和更少的预处理](https://devdocs.magento.com/guides/v2.4/frontend-dev-guide/css-topics/css-preprocess.html#fedg_css-import){target="_blank"}
...
* [编码标准更少](https://developer.adobe.com/commerce/php/coding-standards/less/){target="_blank"}
...
* [使用Sass预处理器和Gulp任务运行程序](https://developer.adobe.com/commerce/frontend-core/guide/css/custom-preprocessor/gulp-sass/){target="_blank"}
* [编译模式](https://developer.adobe.com/commerce/frontend-core/guide/css/quickstart/compilation-mode/){target="_blank"}

**第四节：JavaScript（图像小组件、图像库、客户数据模块、挖空模板）**
...
* [在 [!DNL Commerce]](https://developer.adobe.com/commerce/frontend-core/javascript/requirejs/){target="_blank"}
...
* [自定义挖空.js绑定](https://devdocs.magento.com/guides/v2.4/ui_comp_guide/concepts/knockout-bindings.html){target="_blank"}
...
* [使用计数编译LESS](https://developer.adobe.com/commerce/frontend-core/guide/css/debug/){target="_blank"}
