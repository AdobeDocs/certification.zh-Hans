...
* Composer
* SSH，基本Linux
* Redis，Elasticsearch， SQL，涂漆， RabbitMQ
...
* 正确应用观察者、偏好设置和插件（排序顺序的影响）
* 演示在Adobe中使用配置层的能力 [!DNL Commerce]
* 演示路由在Adobe中的工作方式 [!DNL Commerce]
* 演示自定义页面生成器的能力
* 确定在单个实例上配置多个站点的效果和限制
* 描述依赖项注入的功能和约束
* 介绍如何在商店设置中添加和配置字段
* 解释Git修补程序的用例以及Composer中的文件级修改
* 在CLI中创建新命令
* 演示如何编写集成测试
...
* [[!DNL Commerce] 对于开发人员 — 声明性架构](https://experienceleague.adobe.com/docs/commerce-learn/tutorials/getting-started/development/backend-5-2-declarative-schema.html){target="_blank"}
...
* [Pro项目工作流](https://devdocs.magento.com/cloud/architecture/pro-develop-deploy-workflow.html){target="_blank"}
