...
* [如何启动考试并连接到监考人](https://express.adobe.com/page/6tQ2pnEDumKY7/){target="_blank"}
...
您可以在安排考试时应用优惠券代码。 如果您有折扣，则会在结帐时应用。

**合作伙伴折扣**

铜牌及以上版本的合作伙伴可在所有Adobe认证考试和课程中享受折扣。 您可以阅读更多有关这些折扣以及如何访问合作伙伴权益的信息，请参见 [解决方案合作伙伴门户](https://solutionpartners.adobe.com/solution-partners/home/learn/credentials/certification/certification_exam_registration_and_management.html?nav=cost){target="_blank"}.

**其他折扣**

此外，所有考生在通过以下渠道购买时，可享受批量购买10个或更多考试的折扣 [Adobe认证凭证中心](https://market.xvoucher.com/adobe/global){target="_blank"}.
...
| PSI | 在某一地点或以日语提供委托考试的测试交付供应商 | [电子邮件](mailto:adobe.psisupport@psionline.com){target="_blank"} |
...
* [考生考试者系统要求](https://www.examity.com/test-taker-systems-requirements/){target="_blank"}
...
_所有销售都是最终的。_ 不接受退货和退款。 Adobe考试凭单是按考试级别购买的，不是用于特定考试，因此提供了灵活性。

* 示例：当您购买10张Adobe Certified Expert级别的考试凭单并分发时，您无需提前了解或规划谁将参加哪个Expert考试。
* 管理员可以将优惠券分配给用户，并查看优惠券是否被查看、兑换或者考试是在计划或举行的时间。

+++

+++接受哪种类型的付款？

可以通过（所有主要的）信用卡付款。 通过信用卡进行支付需要接受在线点击式包裹协议。 不同的付款选项包括：
...
+++我可以购买的凭单数量是否存在最小值或最大值？

不，没有最小值或最大值。 客户购买仅限于可用资金，如信用卡限额或电汇的银行账户余额。
...
将优惠券分配给您之后，您将从support@xvoucher.com收到一封电子邮件，其中包含优惠券代码和如何兑换优惠券的说明。 如果您没有收到电子邮件，请检查您的垃圾邮件文件夹。 如果您仍然找不到电子邮件，则可以登录您的Xvoucher帐户。

+++

+++凭单是否可以退款或退款？

所有销售都是最终的。 不接受退货和退款。 Adobe考试凭单是按考试级别购买的，不是用于特定考试，这提供了很大的灵活性。
...
| 配置文件 | [包含帐户名称、地址、公司等位置的人口统计信息页面。 名称只能由Adobe管理员更新](https://www.certmetrics.com/adobe/candidate/demographics.aspx){target="_blank"}. |
| 标识 | [Adobe/登录ID的位置。 通常从亚行开始](https://www.certmetrics.com/adobe/candidate/identification.aspx){target="_blank"} |
...
认证考试通过后，您将获得数字认证服务提供商Credly颁发的Adobe Experience Cloud数字徽章。

您的徽章可切实证明您精通Adobe Experience Cloud产品。 通过将其显示在您的社交媒体个人资料或简历上，您可以向潜在的雇主和客户展示您的成就，并在这些应用程序中展示您的技能。

**对于现有用户，可通过两种方式接受Adobe认证徽章：**

* **步骤1：** 登录 [credly](https://www.credly.com/users/sign_in){target="_blank"}. _(您必须使用用于获取Adobe凭据的同一电子邮件，否则您将看不到徽章。)_
* **第2步：** 或者转到您从Credly收到的电子邮件以接受徽章。
* **步骤3：** 接受并共享您的徽章。

**对于新用户，请按照下面的说明接受您的Adobe认证徽章：**

* **步骤1：** 转到您从Credly收到的电子邮件以接受徽章。
* **第2步：** 创建帐户。 _(您必须使用用于获取Adobe凭据的同一电子邮件，否则您将看不到徽章。)_
* **步骤3：** 接受并共享您的徽章。
