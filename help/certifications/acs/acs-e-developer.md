---
title: 开发人员专家认证
description: 了解如何成为经认证的Adobe Developer专家Adobe [!DNL Campaign Standard].
solution: Campaign,Campaign Standard
product: Campaign
role: Developer
badge: label="Exam AD0-E306" type="besitive"
mini-toc-levels: 1
...
# 认证历程Adobe [!DNL Campaign Standard] 开发人员专家
...
* 在多渠道数字营销活动和Web开发（例如，REST API）中至少拥有两年的相关经验
* 能够在Adobe Campaign中执行任务，包括模板开发、技术工作流、模式开发和集成，并且能够使用控制面板监控实例
* 在渠道投放环境（电子邮件、直邮、移动设备和社交）中工作的体验
* 熟悉多接触、生命周期和重新激活等营销活动策略
* 了解营销量度，如投资回报率、点进率和转化率。
* 管理营销自动化平台的经验
* CSS、HTML和JavaScript、电子邮件的基本知识
* 关系数据库与数据建模的基础知识
* 对技术工作流的了解和配置
* 扩展收件人表或模式和数据管理的体验
* 创建分类规则、工作流、投放和营销活动模板
* 配置的角色和权限
* 使用管理控制台以及与其他Adobe应用程序集成的体验
* 对Adobe I/O和Adobe I/O Runtime的认识
* 在多渠道上处理事务型消息传递和消息投放的体验
* 使用受管资源包的体验
...
完成 [在线准备调查表](https://scorpion.caveon.com/launchpad/ad-q-e306-readiness-questionnaire-for-adobe-campaign-standard-developer-expert-exam){target="_blank"} 以查看您当前的体验是否与建议的最低候选资格匹配。

**考试目标和范围**

第1节：数据建模和管理(26%)

* 在某种情况下，将客户端需求转换为自定义资源
* 确定如何配置屏幕和过滤器定义
* 在给定情景下，确定定义键值、索引和链接的正确策略
* 确定发布资源更新的正确方法
* 数据建模问题疑难解答
* 确定构建技术工作流的正确方法
...
* 确定正确的服务和订阅使用方法
* 在此情景下，验证投放机制
* 确定使用Creative Designer构建电子邮件的正确方法
* 确定创建自定义报告的正确方法
...
* [创建自定义资源](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/creating-a-custom-resource.html?lang=en){target="_blank"}
...
* [为自定义资源配置屏幕定义](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/configuring-a-screen-definition-for-a-custom-resource.html?lang=en){target="_blank"}
...
* [配置过滤器定义](https://experienceleague.adobe.com/docs/campaign-standard/using/developing/adding-or-extending-a-resource/configuring-filter-definition.html?lang=en){target="_blank"}
* [链接自定义资源](https://experienceleague.adobe.com/docs/campaign-standard-learn/creating-custom-resources/linking-custom-resources.html?lang=en){target="_blank"}
