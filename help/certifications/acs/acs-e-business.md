...
您应具有在渠道投放环境（电子邮件、直邮、移动设备和社交）中工作的经验；熟悉营销活动策略，例如多点接触、生命周期和重新激活；并了解营销量度，例如ROI、点击率和转化。

此外，您还应该拥有：

* 现场使用经验 [!DNL Campaign Standard] 有规律的频率
* 能够处理数据文件
* 了解关系数据库、触发器、API和技术工作流的概念
* 了解如何构建营销工作流以及使用基础数据启动营销工作流
* 配置报表的体验
* 了解活动投放设置和批准
...
[!BADGE PSI]{type=Informative url="https://www.certmetrics.com/adobe/candidate/psi_sso_adobe.aspx?redir=yes&amp;ec=AD0-E307 newtab=true"}[!BADGE 考试]{type=Informative url="https://www.certmetrics.com/adobe/candidate/examity_sso.aspx?eid=AD0-E307 newtab=true"}
