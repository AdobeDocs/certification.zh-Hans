...
课程评估是免费的。 没有必要安排这些活动，而且它们也不受监察。 如果您拥有多个Adobe Target Expert和主控级别的认证，则只需完成以下要求，并且您的所有Adobe Target这一级别的认证都将获得续订。

[客户推荐表，用于 [!DNL Adobe Target]](https://www.certmetrics.com/adobe/candidate/caveon_sso_adobe.aspx?ssoLogin=true&amp;eid=ADR-EA400){target="_blank"}
...
>[!NOTE]
>
>您可以重复执行上述操作，直到成功完成三个活动或完成两个活动以及客户证明资料表。
