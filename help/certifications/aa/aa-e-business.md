...
>[!NOTE]
>
>**可用的新研究资源：** 此 [考试准备指南](https://app.rockinfo.com/courses/playScorm/533) 提供量身定制的认证考试准备流程，包括成功获得此认证所需的资料。 _如果系统提示您登录《备考指南》，请使用您的Adobe ID。_
...
* 考虑根据给定场景使用报告工具的优势
* 比较流失和流量可视化图表以及报表的相应变量类型
* 应用流程以计划项目和Data Warehouse
* 应用此过程以针对不同的用户和/或组共享项目以及Reporting and Analytics功能板
* 应用进程以设置警报
* 应用进程查找维度/组件
* 应用流程以创建可视化图表
* 给定场景，确定要使用的相应项目
