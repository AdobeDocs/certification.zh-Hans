---
title: 项目经理专业认证
description: 了解如何成为Adobe认证的项目经理专业Adobe [!DNL Workfront].
solution: Workfront
role: Developer
badge: label="Exam AD0-E903" type="besitive"
mini-toc-levels: 1
...
# 认证历程Adobe [!DNL Workfront] 项目经理专业人员

了解如何成为经认证的Adobe项目经理专业人员。

## 最低体验

您应该：

* 从最初的工作请求到完成，或接触到项目或工作管理，对工作流程的了解
* 完成了自我指导培训或训练集，或是 [!DNL Workfront] 用户6-12个月，以便他们了解基本功能
* 了解如何配置、跟踪和监视报表数据
...
**考试详细信息 — Adobe [!DNL Workfront] 项目经理**
...
完成 [在线准备调查表](https://scorpion.caveon.com/launchpad/ad-q-e903-readiness-questionnaire-for-adobe-workfront-project-manager-professional/ad-q-e903-readiness-questionnaire-for-adobe-workfront-project-manager-professional){target="_blank"} 以查看您当前的体验是否与建议的最低候选资格匹配。
...
* 确定接收工作请求通知的不同方式
* 给定请求后，请查看自定义数据以确定相应的操作
* 在某种情况下，确定活动所需的共享权限
* 在给定方案下，确定适当的任务设置以计划在特定时间范围内执行任务
* 确定在项目中查找关键数据的方法
* 确定跟踪项目风险的不同方式
* 在中确定对象的正确层次结构 [!DNL Workfront]
* 确定用于查看特定分配资源的相应字段
* 给定角色，确定在项目/工作流程的工作进入或规划阶段对角色有用的摄取或规划报表/功能板

第二节：执行(50%)

* 确定了解、应用和衡量项目里程碑的方法
* 创建 [!DNL Workfront] 单次使用批准和何时使用批准
* 识别系统如何使用不同的日期类型
* 在某种情况下，确定日期类型向项目经理传递的信息
* 在给定方案下，确定使用时不同的任务约束对项目时间轴有何影响
* 在给定的情景中，演示如何查找项目团队以及如何通知他们工作分配、更新或完成工作项
* 在给定的情景中，描述如何上传文档并生成校样
* 确定管理项目的不同方式
* 在给定方案下，确定单个项目中特定任务职责的计划差异
* 在此情景下，在 [!DNL Workfront]
* 给定甘特图，解释图表上的对象关系
* 比较条件和进度状态之间的差异
* 识别方式 [!DNL Workfront] 团队和 [!DNL Workfront] 可使用群组
* 在此情景中，描述如何向利益相关方提供所需的信息
* 在给定的方案中，确定日期类型和持续时间对项目条件的影响情况
* 如果出现这种情况，请确定需要自定义状态
* 确定 [!DNL Workfront]
* 在某种情况下，描述构建自定义报表的步骤
...
* 给定特定对象状态，确定需要执行哪些活动或触发哪些操作
* 在某种情况下，确定报表类型和用于修改任务列表或报表的报表元素
* 识别可在报表中使用的不同通配符
* 确定可用于衡量项目成功与否的项目元素
...
[为新规划人员提供核心团队培训 [!DNL Workfront] 体验](https://experienceleague.adobe.com/docs/workfront-course-map/using/learning-programs/core-team-training-program-for-planners.html){target="_blank"}
...
* [更新项目的工作](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FManage_work%2FProjects%2FUpdating_Work_in_a_Project%2F_update-work-on-project.htm&amp;_LANG=en){target="_blank"}
...
* [Adobe [!DNL Workfront] 基础知识](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FWorkfront_basics%2F_workfront-basics.htm&amp;_LANG=en){target="_blank"}
...
* [敏捷Adobe入门 [!DNL Workfront]](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FAgile%2FGet_Started_with_Agile_in_Workfront%2F_get-started-with-agile.htm&amp;_LANG=en){target="_blank"}
* [创建和管理报表](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FReports_and_Dashboards%2FReports%2FCreating_and_Managing_Reports%2F_create-manage-reports.htm&amp;_LANG=en){target="_blank"}

**第二节：执行**

* [审批流程和里程碑路径](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FAdministration_and_Setup%2FCustomize_Workfront%2FConfigure_approval_milestone_processes%2F_config-approval-milestone-paths.htm&amp;_LANG=en){target="_blank"}
...
* [任务约束](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FManage_work%2FTasks%2FTask_Constraints%2F_task-constraints.htm&amp;_LANG=en){target="_blank"}
* [使用主页区域](https://one.workfront.com/s/document-item?bundleId=workfront-classic&amp;topicId=Content%2FWorkfront_basics%2FUsing_Home%2FUsing_the_Home_Area%2F_use-the-home-area.htm&amp;_LANG=en){target="_blank"}
* [添加新文档以Adobe [!DNL Workfront]](https://one.workfront.com/s/document-item?bundleId=workfront-classic&amp;topicId=Content%2FDocuments%2FAdding_Documents_to_Workfront%2F_add-new-documents-_to-workfront.htm&amp;_LANG=en){target="_blank"}
* [燃耗](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FAgile%2FUse_Scrum_in_an_Agile_Team%2FBurndown%2F_burndown.htm&amp;_LANG=en){target="_blank"}
...
* [与组和团队合作](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FPeople_Teams_and_Groups%2FWork_with_Groups_and_Teams%2F_work-with-groups-and-teams.htm&amp;_LANG=en){target="_blank"}
* [更新项目的工作](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FManage_work%2FProjects%2FUpdating_Work_in_a_Project%2F_update-work-on-project.htm&amp;_LANG=en){target="_blank"}
...
* [在Adobe中创建和管理工时单 [!DNL Workfront]](https://one.workfront.com/s/document-item?bundleId=the-new-workfront-experience&amp;topicId=Content%2FTimesheets%2FCreate_and_Manage_Timesheets%2F_create-and-manage-timesheets.htm&amp;_LANG=en){target="_blank"}
...
* [项目时间轴](https://www.workfront.com/project-management/knowledge-areas/time-management/project-timeline){target="_blank"}
